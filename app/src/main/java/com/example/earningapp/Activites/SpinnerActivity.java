...
import com.example.earningapp.SpinWeel.LuckyItem;
import com.example.earningapp.SpinWeel.LuckyWheelView;
...
public class SpinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        luckyItem8.color = Color.parseColor("#eceff1");
        data.add(luckyItem8);
